      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 w-full text-center lg:text-left">
            ...
            <p className="font-light tracking-wide text-gray-400 text-base text-xl sm:text-lg max-w-2xl mx-auto">
              Clear, accurate, and visually compelling illustrations that
              transform complex medical concepts into accessible, professional
              visuals. Built for clinicians, educators, and biomedical teams.
            </p>
          </div>
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="flex-shrink-0">
                      <div
                        ...
                        bg-gradient-to-r from-pink-400 to-pink-500 bg-clip-text
                        text-transparent"
                      >
                        "
                      </div>
